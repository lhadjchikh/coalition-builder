...
variable "enable_api_custom_domain" {
  description = "Point api.<domain_name> at the API Gateway Zappa deployed. Leave false until Zappa has deployed the stage, since Terraform looks the API up by name."
  type        = bool
  default     = false
}
