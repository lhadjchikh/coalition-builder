...
func TestComputeModulePasswordVariables(t *testing.T) {
	...
	// Create a minimal test case for the compute module
	terraformOptions := &terraform.Options{
		...
		Vars: map[string]interface{}{
			...
			"api_target_group_arn":      "arn:aws:elasticloadbalancing:us-east-1:123456789012:targetgroup/test/1234567890123456",
			...
			"site_password_enabled":     true,
			"site_password":             "module-test-password",
		},
		NoColor: true,
	}
	...
	// Verify the module accepts the password variables
