...
// Generic homepage interface for footer
interface Homepage {
    ...
    <footer className={className || "bg-gray-900"}>
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          {showSocialLinks && (
            <div className="mb-6">
              <SocialLinks homepage={homepage} className="flex justify-center space-x-6" />
            </div>
          )}
          ...
          <div className="pt-8 border-t border-gray-800">
            <p className="text-gray-400 text-sm">
              © {currentYear} {homepage.organization_name}. All rights reserved.
            </p>
          </div>
        </div>
      </div>
