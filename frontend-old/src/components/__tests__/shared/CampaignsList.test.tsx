...
import CampaignsList from '@shared/components/CampaignsList';
...
describe('CampaignsList', () => {
  ...
  describe('Basic rendering', () => {
    ...
    it('renders campaign summaries', () => {
      ...
      expect(screen.getByText('Urgent action on climate change')).toBeInTheDocument();
    });
  ...
  describe('Loading and error states', () => {
    it('displays loading state', () => {
      ...
      const spinner = screen.getByTestId('loading').querySelector('.animate-spin');
  ...
  describe('Campaign cards', () => {
    it('renders campaign images with ImageWithCredit component', () => {
      ...
      expect(climateImage).toHaveAttribute('src', 'https://example.com/climate.jpg');
    });
    ...
    it('applies custom card className', () => {
      render(<CampaignsList {...defaultProps} cardClassName="custom-card-class" />);
  ...
  describe('Heading display', () => {
    ...
    it('shows custom heading text', () => {
      render(
        <CampaignsList {...defaultProps} showHeading={true} headingText="Active Initiatives" />
      );
  ...
  describe('Accessibility', () => {
    it('has proper ARIA attributes', () => {
      ...
      expect(cards[0]).toHaveAttribute('aria-label', 'View details for Save the Bay');
      expect(cards[1]).toHaveAttribute('aria-label', 'View details for Clean Water Initiative');
    });
  ...
  describe('Edge cases', () => {
    ...
    it('handles special characters in content', () => {
      ...
      expect(screen.getByText('Summary with <special> characters & symbols')).toBeInTheDocument();
    });
