...
import ImageWithCredit from '@shared/components/ImageWithCredit';
...
describe('ImageWithCredit', () => {
  ...
  describe('Basic rendering', () => {
    ...
    it('applies custom className to container', () => {
      const { container } = render(<ImageWithCredit {...defaultProps} className="custom-class" />);

      expect(container.firstChild).toHaveClass('custom-class');
    });

    it('applies custom imgClassName to image', () => {
      render(<ImageWithCredit {...defaultProps} imgClassName="custom-img-class" />);
  ...
  describe('Credit text building', () => {
    ...
    it('builds credit with license only', () => {
      ...
      expect(screen.getByText('is licensed under CC BY 4.0')).toBeInTheDocument();
    });
    ...
    it('builds credit with all fields', () => {
      ...
      expect(
        screen.getByText('"Beautiful Sunset" by John Doe is licensed under CC BY 4.0')
      ).toBeInTheDocument();
    });
    ...
    it('ignores empty string fields', () => {
      render(<ImageWithCredit {...defaultProps} title="" author="John Doe" license="" />);
  ...
  describe('Credit display modes', () => {
    ...
    describe('caption mode (default)', () => {
      it('displays credit as caption below image', () => {
        ...
        expect(creditDiv).toHaveTextContent('by John Doe is licensed under CC BY 4.0');
      });

      it('displays credit as link when sourceUrl provided', () => {
        render(<ImageWithCredit {...propsWithCredit} sourceUrl="https://example.com/source" />);
    ...
    describe('overlay mode', () => {
      it('displays credit as overlay on image', () => {
        ...
        expect(overlay).toHaveTextContent('by John Doe is licensed under CC BY 4.0');
      });
    ...
    describe('tooltip mode', () => {
      it('displays credit as tooltip on hover', () => {
        ...
        expect(tooltipContent).toHaveClass('text-white', 'px-2', 'py-1', 'rounded');
        expect(tooltipContent).toHaveTextContent('by John Doe is licensed under CC BY 4.0');
      });
    });

    describe('none mode', () => {
      it('hides credit when creditDisplay is none', () => {
        const { container } = render(<ImageWithCredit {...propsWithCredit} creditDisplay="none" />);
  ...
  describe('Edge cases', () => {
    ...
    it('handles very long credit text', () => {
      ...
      render(
        <ImageWithCredit {...defaultProps} title={longText} author={longText} license={longText} />
      );
    ...
    it('handles special characters in credit fields', () => {
      ...
      expect(screen.getByText(/CC BY-SA 4.0 <International>/)).toBeInTheDocument();
    });
  });
});
