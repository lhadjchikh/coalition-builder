...
describe('PageLayout', () => {
  ...
  it('should display error message when error is provided', () => {
    ...
    expect(screen.getByText('Unable to load test page at this time.')).toBeInTheDocument();
  });
  ...
  it('should render navbar when NavbarComponent is provided', () => {
    const MockNavbar = ({ organizationName, logoUrl, logoAltText, navItems }: { 
      ...
      <nav data-testid="navbar">
        ...
        {logoUrl && <div data-testid="logo" data-src={logoUrl} data-alt={logoAltText}>Logo</div>}
    ...
    expect(screen.getByTestId('logo')).toHaveAttribute('data-src', 'https://example.com/logo.png');
    expect(screen.getByTestId('logo')).toHaveAttribute('data-alt', 'Organization Logo');
  });
  ...
  it('should render footer when FooterComponent is provided', () => {
    const MockFooter = ({ orgInfo }: { orgInfo: { organization_name: string } }) => (
  ...
  it('should handle navbar with theme data', () => {
    const MockNavbar = ({ organizationName, logoUrl, logoAltText }: { organizationName?: string; logoUrl?: string; logoAltText?: string }) => (
