...
const mockLoadGoogleFonts = loadGoogleFonts as jest.MockedFunction<
  typeof loadGoogleFonts
>;
...
describe("Google Fonts Integration in Components", () => {
  ...
  it("should load Google Fonts and apply CSS custom properties for typography", async () => {
    ...
    // Import and directly call the theme application function
    const { applyThemeToDocument } = await import("../../utils/theme");
    applyThemeToDocument(theme);

    render(<FontTestComponent />);
