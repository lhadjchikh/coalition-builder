...
describe("useStyledTheme", () => {
  ...
  describe("typography utilities", () => {
    it("should generate responsive font sizes", () => {
      ...
      const responsiveSize =
        result.current.typography.getResponsiveFontSize("base");
    ...
    it("should generate responsive font sizes for different sizes", () => {
      ...
      const responsiveXl =
        result.current.typography.getResponsiveFontSize("xl");
      expect(responsiveXl.fontSize).toBe("1.25rem");

      const responsiveSm =
        result.current.typography.getResponsiveFontSize("sm");
  ...
  describe("theme variations", () => {
    it("should work with different theme variations", () => {
      ...
      const { result } = renderHook(() => useStyledTheme(), {
  ...
  describe("performance considerations", () => {
    it("should maintain referential equality for static objects", () => {
      const { result, rerender } = renderHook(() => useStyledTheme(), {
        wrapper,
      });
