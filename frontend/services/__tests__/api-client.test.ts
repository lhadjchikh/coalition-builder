...
describe('BaseApiClient', () => {
  ...
  describe('getCampaigns', () => {
    it('should fetch campaigns', async () => {
      ...
      expect(client.requestMock).toHaveBeenCalledWith('/api/campaigns/', undefined);
    });
  });
  ...
  describe('getCampaignById', () => {
    it('should fetch campaign by ID', async () => {
      ...
      expect(client.requestMock).toHaveBeenCalledWith('/api/campaigns/1/', undefined);
    });
  });

  describe('getCampaignByName', () => {
    it('should fetch campaign by name', async () => {
      const mockCampaign: Campaign = { id: 1, name: 'test-campaign' } as Campaign;
      client.requestMock.mockResolvedValue(mockCampaign);
      ...
      expect(client.requestMock).toHaveBeenCalledWith(
        '/api/campaigns/by-name/test-campaign/', undefined
      );
    });
    ...
    it('should encode special characters in name', async () => {
      ...
      expect(result).toEqual(mockCampaign);
      expect(client.requestMock).toHaveBeenCalledWith(
        '/api/campaigns/by-name/test%20campaign/', undefined
      );
    });
  });
  ...
  describe('getCampaign', () => {
    it('should fetch campaign', async () => {
      ...
      expect(result).toEqual(mockCampaign);
      expect(client.requestMock).toHaveBeenCalledWith('/api/campaigns/2/', undefined);
    });
  });
  ...
  describe('getEndorsers', () => {
    it('should fetch endorsers', async () => {
      ...
      expect(client.requestMock).toHaveBeenCalledWith('/api/endorsers/', undefined);
    });
  });
  ...
  describe('getLegislators', () => {
    it('should fetch legislators', async () => {
      ...
      expect(client.requestMock).toHaveBeenCalledWith('/api/legislators/', undefined);
    });
  });
  ...
  describe('getEndorsements', () => {
    it('should fetch endorsements', async () => {
      ...
      expect(client.requestMock).toHaveBeenCalledWith('/api/endorsements/', undefined);
    });
  });
  ...
  describe('getCampaignEndorsements', () => {
    it('should fetch campaign endorsements', async () => {
      ...
      expect(result).toEqual(mockEndorsements);
      expect(client.requestMock).toHaveBeenCalledWith(
        '/api/endorsements/?campaign_id=1', undefined
      );
    });
  });
  ...
  describe('getHomepage', () => {
    it('should fetch homepage', async () => {
      ...
      expect(client.requestMock).toHaveBeenCalledWith('/api/homepage/', undefined);
    });
  });
  ...
  describe('getHomepageById', () => {
    it('should fetch homepage by ID', async () => {
      ...
      expect(result).toEqual(mockHomepage);
      expect(client.requestMock).toHaveBeenCalledWith('/api/homepage/2/', undefined);
    });
  });
  ...
  describe('getContentBlocks', () => {
    it('should fetch content blocks', async () => {
      ...
      expect(client.requestMock).toHaveBeenCalledWith('/api/content-blocks/', undefined);
    });
  });
  ...
  describe('getContentBlocksByPageType', () => {
    it('should fetch content blocks by page type', async () => {
      ...
      expect(result).toEqual(mockBlocks);
      expect(client.requestMock).toHaveBeenCalledWith(
        '/api/content-blocks/?page_type=homepage', undefined
      );
    });
  });
  ...
  describe('getTermsOfUse', () => {
    it('should fetch terms of use', async () => {
      ...
      expect(client.requestMock).toHaveBeenCalledWith('/api/legal/terms/', undefined);
    });
  });
  ...
  describe('getPrivacyPolicy', () => {
    it('should fetch privacy policy', async () => {
      ...
      expect(result).toEqual(mockDoc);
      expect(client.requestMock).toHaveBeenCalledWith('/api/legal/privacy/', undefined);
    });
  });
});